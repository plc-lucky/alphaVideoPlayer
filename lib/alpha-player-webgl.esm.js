...
var css_248z = ".shader_video_player_webgl .hidden-video[data-v-7a46b578]{display:none}.shader_video_player_webgl .canvas-container .loading[data-v-7a46b578]{align-items:center;color:rgba(0,0,0,.6);display:flex;flex-direction:column;justify-content:center}.shader_video_player_webgl .canvas-container .loading .loading-spinner[data-v-7a46b578]{animation:spin-7a46b578 1s linear infinite;border:4px solid rgba(0,0,0,.3);border-radius:50%;border-top-color:#000;height:40px;margin-bottom:20px;width:40px}@keyframes spin-7a46b578{0%{transform:rotate(0deg)}to{transform:rotate(1turn)}}";
styleInject(css_248z);

script.render = render;
script.__scopeId = "data-v-7a46b578";
script.__file = "components/alpha-player-webgl/alpha-player-webgl.vue";

// 组件安装函数
const install = (app) => {
  app.component("AlphaPlayerWebgl", script);
};
