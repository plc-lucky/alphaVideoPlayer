import { createElementBlock, openBlock, createCommentVNode, createElementVNode, createTextVNode, renderSlot } from 'vue';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createElementBlock("div", _hoisted_1, [
    createCommentVNode(" 隐藏的视频元素，用作纹理源 "),
    createElementVNode("video", {
      ...
      _cache[6] || (_cache[6] = createTextVNode(" 您的设备不支持视频播放 ", -1 /* CACHED */))
    ], 40 /* PROPS, NEED_HYDRATION */, _hoisted_2),
    createCommentVNode(" WebGL 渲染容器 "),
    createElementVNode("div", _hoisted_4, [
      createCommentVNode("loading"),
      (!$data.isVideoLoaded)
        ? (openBlock(), createElementBlock("div", _hoisted_5, [
            renderSlot(_ctx.$slots, "loading", {}, () => [
              _cache[7] || (_cache[7] = createElementVNode("i", { class: "loading-spinner" }, null, -1 /* CACHED */)),
              _cache[8] || (_cache[8] = createElementVNode("p", { class: "loading_text" }, "动效加载中...", -1 /* CACHED */))
            ])
          ]))
...
var css_248z = ".shader_video_player_webgl .hidden-video[data-v-792dbe85]{display:none}.shader_video_player_webgl .canvas-container .loading[data-v-792dbe85]{align-items:center;color:rgba(0,0,0,.6);display:flex;flex-direction:column;justify-content:center}.shader_video_player_webgl .canvas-container .loading .loading-spinner[data-v-792dbe85]{animation:spin-792dbe85 1s linear infinite;border:4px solid rgba(0,0,0,.3);border-radius:50%;border-top-color:#000;height:40px;margin-bottom:20px;width:40px}@keyframes spin-792dbe85{0%{transform:rotate(0deg)}to{transform:rotate(1turn)}}";
styleInject(css_248z);

script.render = render;
script.__scopeId = "data-v-792dbe85";
script.__file = "components/alphaVideoPlayer/alphaVideoPlayerWebGL.vue";

// 组件安装函数
const install = (app) => {
  app.component('AlphaVideoPlayerWebGL', script);
};
